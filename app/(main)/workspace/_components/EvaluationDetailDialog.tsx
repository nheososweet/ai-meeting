...
export function EvaluationDetailDialog({
  ...
  const totalDeduction = useMemo(() => {
    ...
    return Object.values(evaluation.deductions_per_code).reduce((acc, d) => acc + d, 0);
  }, [evaluation]);
                                      ...
                                      <TooltipContent side="top" className="max-w-[300px] p-3 shadow-xl">
                                        <div className="space-y-1.5">
                                          <div className="flex items-center justify-between gap-4">
                                            ...
                                            <p className="text-[10px] font-black uppercase tracking-tighter text-red-500">Trừ {criteriaMap[errId]?.deduction}đ</p>
                                          </div>
